...
var skip_to_front := ThemeConfig.ui_icon("res://addons/net.yarvis.pixel_pen/resources/icon/skip-backward.svg")
var step_backward := ThemeConfig.ui_icon("res://addons/net.yarvis.pixel_pen/resources/icon/step-backward.svg")
var play := ThemeConfig.ui_icon("res://addons/net.yarvis.pixel_pen/resources/icon/play.svg")
var pause := ThemeConfig.ui_icon("res://addons/net.yarvis.pixel_pen/resources/icon/pause.svg")
var step_forward := ThemeConfig.ui_icon("res://addons/net.yarvis.pixel_pen/resources/icon/step-forward.svg")
var skip_to_end := ThemeConfig.ui_icon("res://addons/net.yarvis.pixel_pen/resources/icon/skip-forward.svg")
