...
func get_indexed_datas(image: Image, colors: Array) -> PackedByteArray:
	_shader = load("res://addons/net.yarvis.pixel_pen/thirdparty/gdgifexporter/lookup_color.gdshader")
	return _convert(image, colors)


func get_similar_indexed_datas(image: Image, colors: Array) -> PackedByteArray:
	_shader = load("res://addons/net.yarvis.pixel_pen/thirdparty/gdgifexporter/lookup_similar.gdshader")
	return _convert(image, colors)
